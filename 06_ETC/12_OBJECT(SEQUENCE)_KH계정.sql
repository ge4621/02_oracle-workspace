/*
    ...
    EX) 회원번호, 사원번호, 개시글번호 등 절대 겹쳐서는 안되는 데이터들...
*/
...
/*
    ...
    [CYCLE|NOCYCLE]         --값 순환여부 지정 (기본값 NOCYCLE) =>최대값 찍고 처음부터 다시 돌아와서 시작할 수 있게 함
...
--왜>> =< 마지막으로 성공적으로 수행된, NEXTTVAL 값이기 때문에;

--SELECT 여러번 치지말기!
SELECT SEQ_EMPNO.NEXTVAL FROM DUAL; --300
SELECT SEQ_EMPNO.NEXTVAL FROM DUAL; --300 : 마지막으로 성공한 NEXTVAL의 값
